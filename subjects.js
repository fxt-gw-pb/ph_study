...
(function () {
  ...
  window.SUBJECTS_REGISTRY = [
    ...
    },
    {
      ...
      icon: '精',
      subtitle: '大礼包暂无往年题',
      blurb: '本次大礼包资料中未收录精神病学的往年题，因此暂未整理考点与题库。下方仅为占位章节结构，待日后取得真题后再补充。',
      dataVar: 'PSY_SITE_DATA',
      accent: '#7a4ec9',
      status: 'placeholder',
      noExam: true,
      noExamNote: '本学科的「大礼包」资料中没有往年题，因此暂时无法像其他学科那样整理考点与题库。下方章节与知识点均为占位示例（非真实考频）。如果你手头有精神病学的往年题或口试回忆，欢迎点击勘误按钮反馈，我们会尽快整理上线。',
    },
    {
