...
(function () {
  ...
  window.SUBJECTS_REGISTRY = [
    ...
    },
    {
      ...
      icon: '精',
      subtitle: '往年题考点 · 2026 春',
      blurb: '基于 06–07 / 09 / 16 / 20 / 21 级往年题与题库-久远资料整理，按章节与考频组织。',
      dataVar: 'PSY_SITE_DATA',
      accent: '#7a4ec9',
      status: 'ready',
      intro: [
        '基于《精神病学复习整理by18级杨子铭》与精神病学往年题文件夹全部资料整理（06–07 级史前回忆、09 级试题、16 级考题、20 / 21 级回忆，及题库-久远练习/答案卷）。',
        '本次共拆分 1348 个题目条目；每题均已归入至少一个考点。同一章节内按考频从高到低排序。',
        '知识点正文均摘自《精神病学复习整理by18级杨子铭》；未完全匹配者归入「附」章，欢迎勘误与补充。',
      ],
    },
    {
